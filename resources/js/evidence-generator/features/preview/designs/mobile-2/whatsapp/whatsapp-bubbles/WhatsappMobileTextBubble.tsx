        ...
        <div className={['rounded-[8.75px]', isDark ? 'bg-black/20' : 'bg-black/5'].join(' ')}>
            <div className="mb-[3.75px] flex overflow-hidden rounded-[7.5px]">
                ...
                <div className="flex min-w-0 flex-col gap-[7.5px] px-2.5 pt-[5px] pb-2.5">
                    <p
                        className="truncate text-[13.75px] leading-5 font-semibold text-[#0078D7]"
                        style={quote.authorColor ? { color: quote.authorColor } : undefined}
                    >
                        {quote.author}
                    </p>
                    <p className={['line-clamp-2 text-[16.25px] leading-5', isDark ? 'text-[#878F92]' : 'text-black/60'].join(' ')}>{quote.text}</p>
                </div>
            </div>
        </div>
    );
                    ...
                    <div className="box-border p-[5px] select-text">
                        ...
                        <div className="relative overflow-hidden ps-[3.75px] pe-[3.75px] break-words whitespace-pre-wrap">
                            <span
                                ...
                                dir="ltr"
                                className="visible text-[16.25px] leading-[22.5px] font-normal tracking-[0.00625rem] select-text"
                                style={{ minHeight: '0px' }}
                            >
                                {content}
                            </span>
                        ...
                        {(time || (isOut && status)) && (
                            <div className="relative z-10 float-right -mt-[15px] -mb-[6.25px] ps-[5px] pe-0">
                                <div
                                    className={[
                                        'flex h-[18.75px] items-center text-[13.75px] leading-[18.75px] whitespace-nowrap',
                                        metaText,
                                ...
                                >
                                    {time && (
                                        <span className="inline-block align-top" dir="auto">
                                            <span
                                                className={[
                                                    'inline max-w-full min-w-0 text-[13.75px] leading-5 font-normal wrap-break-word break-all whitespace-pre-line select-text',
                                                    metaText,
                                                ].join(' ')}
                                            >
                                                {time}
