...
export function WhatsappMobileHeaderUser({
    ...
    return (
        <div className={['w-full border-b px-1.25 py-[12.5px]', isDark ? 'border-white/5 bg-[#0B1014]' : 'border-black/10 bg-white'].join(' ')}>
            <div className="flex items-center justify-between gap-2.5">
                ...
                <div className="flex shrink-0 items-center gap-[17.5px] text-[#54656f]">
                    ...
                    <button
                        type="button"
                        className={[
                            'grid h-6.25 w-6.25 place-items-center rounded-full transition',
