                        ...
                        {!hasMessageValue && (
                            <button type="button" aria-label="Camara" className="grid h-7 w-7 place-items-center rounded-full">
                                <svg viewBox="0 0 36 32" height="16" width="18" fill="none" aria-hidden="true">
                                    <path d="M34,9.11V26.89c0,1.72-1.39,3.11-3.11,3.11H5.11c-1.72,0-3.11-1.39-3.11-3.11V9.11c0-1.72,1.39-3.11,3.11-3.11h6.18c.57-1.33,1.14-2.67,1.71-4h11c.5,1.34,1,2.67,1.5,4h5.39c1.72,0,3.11,1.39,3.11,3.11Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
                                    <circle cx="18" cy="16" r="6" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
                                </svg>
                            </button>
                        )}
                    </div>
