...
export function SmsMobileHeader({
    ...
    return (
        <header className="flex h-[72px] shrink-0 items-center px-3" style={{ backgroundColor: colors.header, color: colors.primaryText }}>
            ...
            >
                <svg viewBox="0 0 48 48" className="h-[36px] w-[36px] shrink-0" fill={colors.avatarForeground} aria-hidden="true">
            ...
            <button type="button" className="flex h-[42px] w-[35px] shrink-0 items-center justify-center" aria-label="Opciones">
                <svg viewBox="0 0 32 32" className="size-[30px]" fill="none" aria-hidden="true">
                    <circle cx="14.5" cy="10" r="2" fill={colors.headerActionIcon} />
                    <circle cx="14.5" cy="16" r="2" fill={colors.headerActionIcon} />
                    <circle cx="14.5" cy="22" r="2" fill={colors.headerActionIcon} />
                    {showMenuIndicator ? (
                        <>
