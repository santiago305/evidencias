...
export function PreviewMobile1CallDesign2({ data, themeMode }: PreviewProps) {
    ...
    return <Mobile1PreviewFrame themeMode={themeMode} notificationIds={buildMobilePreviewNotificationIds(data, 'mobile-3', 'call')}><MissedCallContent data={data} themeMode={themeMode} /></Mobile1PreviewFrame>;
}
