...
import { Mobile12MoreVerticalIcon } from './Mobile12MoreVerticalIcon';
...
// ============================================================
// CONFIGURACIÓN DE LOS ICONOS DEL HEADER
// ============================================================

// Separación horizontal entre los iconos
const HEADER_ICONS_GAP = 20.5;
...
// Negativo = sube
// Positivo = baja
const VIDEO_ICON_Y = -4;

// Llamada
const AUDIO_ICON_Y = -4.5;
...
export function WhatsappMobileHeaderUser({
    ...
    const avatarTheme = useMemo(
        () =>
            createWhatsappAvatarTheme(
                buildWhatsappAvatarSeed(data),
                themeMode,
            ),
        [data, themeMode],
    );
    ...
    return (
        <div
            className={[
                'w-full border-b px-[5px] py-[8.5px]',
                colors
                    ? isDark
                        ? 'border-white/5'
                        : 'border-black/10'
                    : isDark
                      ? 'border-white/5 bg-[#0B1014]'
        ...
        >
            <div className="flex items-center justify-between gap-2.5">
                ...
                <div className="flex min-w-0 flex-1 items-center gap-2.5">
                    ...
                    <button
                        ...
                        className={[
                            ...
                            isDark
                                ? 'text-slate-200 active:bg-white/15'
                                : 'text-black active:bg-black/10',
                        ].join(' ')}
                        aria-label="Volver"
                        title="Volver"
                    >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <path d="M19.0534 6.47712C19.5794 6.16115 20.262 6.33145 20.578 6.8575C20.634 6.95093 20.6887 7.04537 20.7419 7.14077C21.0404 7.67689 20.8479 8.35353 20.3118 8.65211C19.7756 8.95068 19.099 8.75811 18.8004 8.22199C18.7591 8.14782 18.7166 8.07439 18.673 8.00173C18.357 7.47568 18.5273 6.79309 19.0534 6.47712Z" />
                                        ...
                                        <path d="M20.3118 15.3479C20.8479 15.6465 21.0404 16.3231 20.7419 16.8592C20.6887 16.9546 20.634 17.0491 20.578 17.1425C20.262 17.6686 19.5794 17.8389 19.0534 17.5229C18.5273 17.2069 18.357 16.5243 18.673 15.9983C18.7166 15.9256 18.7591 15.8522 18.8004 15.778C19.099 15.2419 19.7756 15.0493 20.3118 15.3479Z" />

                                        <path d="M17.1425 20.578C17.6686 20.262 17.8389 19.5794 17.5229 19.0534C17.2069 18.5273 16.5243 18.357 15.9983 18.673C15.9256 18.7166 15.8522 18.7591 15.778 18.8004C15.2419 19.099 15.0493 19.7756 15.3479 20.3118C15.6465 20.8479 16.3231 21.0409 16.8592 20.7419C16.9546 20.6887 17.0491 20.634 17.1425 20.578Z" />
                    ...
                    <div className="min-w-0 flex-1 leading-tight">
                        <div
                            className={[
                                'truncate pb-[1.25px] text-[18.25px] leading-[21.25px] font-medium tracking-tight',
                                colors
                                    ? ''
                                    : isDark
                                      ? 'text-white'
                        ...
                        {/* Estado "en línea" oculto actualmente */}
                    </div>
                </div>
                ...
                <div
                    className="flex shrink-0 items-center text-[#54656f]"
                    style={{
                        gap: `${HEADER_ICONS_GAP}px`,
                    }}
                >
                    {/* =================================================
                        VIDEO
                    ...
                    <span
                        ...
                        className={[
                            'relative grid h-[40px] w-[40px] shrink-0 place-items-center',
                            colors
                                ? ''
                                : isDark
                                  ? 'text-slate-200'
                        ...
                        style={{
                            color: colors
                                ? colors.headerIcons
                                : undefined,
                            transform: `translateY(${VIDEO_ICON_Y}px)`,
                        }}
                    >
                        <svg
                            viewBox="0 -3 22 22"
                    ...
                    <span
                        ...
                        style={{
                            color: colors
                                ? colors.headerIcons
                                : undefined,
                            transform: `translateY(${AUDIO_ICON_Y}px)`,
                        }}
                    >
                        <svg
                            viewBox="-2 -5 22 26"
                    ...
                    <button
                        type="button"
                        className={[
                            'relative grid h-[40px] w-[40px] shrink-0 place-items-center rounded-full transition',
                            colors
                                ? isDark
                        ...
                        style={{
                            color: colors
                                ? colors.headerIcons
                                : undefined,
                            transform: `translateY(${MENU_ICON_Y}px)`,
                        }}
                        aria-label="Menu"
                        title="Menu"
                    >
                        <Mobile12MoreVerticalIcon
                            className="h-[24px] w-[7px]"
                        />
                    </button>
                </div>
            </div>
