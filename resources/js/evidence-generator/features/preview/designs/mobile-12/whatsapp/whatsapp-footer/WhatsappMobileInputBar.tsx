            ...
            <div className="flex items-center gap-[8px]">
                ...
                >
                    ...
                    <input
                        aria-label="Mensaje"
                        autoComplete="off"
                        className=" flex-1 h-10.5 bg-transparent text-[16.25px] text-current outline-none placeholder:text-current/90
                ...
                <button
                    ...
                    className={[
                        'grid h-[55px] w-[55px] shrink-0 place-items-center rounded-full transition-colors',
