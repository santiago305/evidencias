...
export function EncryptedMessage({ themeMode = 'light' }: { themeMode?: PreviewThemeMode }) {
    const isDark = themeMode === 'dark';
    const encryptedTextSize = 'text-[10.5px] leading-[15px]';
                                    ...
                                    <div className="relative z-10 rounded-[9.1875px]">
                                        <div className="cursorpointer">
                                            <span>
                                                ...
                                                <span className={`visible min-h-0 wrap-break-word ${encryptedTextSize} text-[#fad99d]`}>
                                                    ...
                                                    <strong className="font-medium">Más información.</strong>
                                                </span>
                                            </span>
                                        </div>
