    ...
    return (
        <div className={['rounded-[8.75px]', isDark ? 'bg-black/20' : 'bg-black/5'].join(' ')}>
            <div className="mb-[3.75px] flex overflow-hidden rounded-[7.5px]">
                <div
                    className={['w-[5px] shrink-0 rounded-s-[7.5px]', quote.accentColor ? '' : (quote.accentClassName ?? 'bg-[#0063CB]')].join(' ')}
                    style={quote.accentColor ? { backgroundColor: quote.accentColor } : undefined}
                />
                <div className="flex min-w-0 flex-col gap-[7.5px] px-2.5 pt-[5px] pb-2.5">
                    <p
...
export function WhatsappMobileTextBubble({ side, firstInGroup, time, status, id, quote, themeMode = 'light', children }: WhatsappTextBubbleProps) {
    ...
    return (
        <div id={id} className={`flex px-[15px] ${isOut ? 'justify-end' : 'justify-start'}`}>
            <div className="relative max-w-[90%] flex-none text-[13.1px] leading-[14.5px] font-[550]">
                {firstInGroup && (
                    <BubbleTail
                ...
                <div className={bubbleClassName} style={bubbleStyle}>
                    <div className="box-border p-[5px] select-text !pe-5 pl-2">
                        ...
                        <div className="relative overflow-hidden ps-[3.75px] pe-[3.75px] break-words whitespace-pre-wrap">
                            <span
                                ...
                                dir="ltr"
                                className="visible text-[13.1px] leading-[15.5px] font-[550] tracking-[0.00625rem] select-text"
                                style={{ minHeight: '0px' }}
                            >
                                {content}
                            </span>
