...
export function Mobile12EncryptedMessage({ themeMode = 'light' }: { themeMode?: PreviewThemeMode }) {
    const isDark = themeMode === 'dark';
    const encryptedTextSize = 'text-[11px] !leading-[0px] !font-[300] text-gray-500';
                            ...
                            <div className={`mx-auto flex ${maxWidth} flex-col justify-center ${horizontalPadding}`}>
                                ...
                                <div
                                    className={[
                                        ...
                                        isDark ? 'bg-[#12181C] text-[#EECC84]' : 'bg-[#FFF0D4] text-black/90',
                                    ].join(' ')}
                                >
                                    <div className="relative z-10 rounded-[9.1875px]">
                                        <div className="cursorpointer">
                                            <span>
                                                ...
                                                <span className={`min-h-0 ${encryptedTextSize}`}>
                                                    ...
                                                    <strong className="!font-[500] !text-gray-500">Más información.</strong>
                                                </span>
                                            </span>
                                        </div>
