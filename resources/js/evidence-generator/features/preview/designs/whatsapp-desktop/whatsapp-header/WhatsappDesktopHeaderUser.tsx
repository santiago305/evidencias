...
type WhatsappDesktopHeaderUserProps = {
    data: WhatsappData;
    status?: MsgStatus;
...
export function WhatsappDesktopHeaderUser({
    data,
    status,
    showTemporaryIndicator = true,
    displayTitle,
    themeMode = 'light',
}: WhatsappDesktopHeaderUserProps) {
    ...
    return (
        <div data-wa-header className={['w-full border-b px-3 py-2', isDark ? 'border-white/5 bg-[#161717]' : 'border-black/10 bg-white'].join(' ')}>
            <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex shrink-0 items-center gap-5 text-[#54656f]">
                    ...
                    <span aria-hidden="true" data-icon="search-refreshed" className={['h-5 w-5', isDark ? 'text-slate-200' : 'text-black'].join(' ')}>
                        <svg viewBox="0 0 24 24" height="20" width="20" fill="none">
