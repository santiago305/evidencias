...
export function PreviewMobile4Sms({ data, themeMode }: PreviewProps) {
    ...
    return (
        <Mobile4PreviewFrame
            themeMode={themeMode}
            notificationIds={buildMobilePreviewNotificationIds(data, 'mobile-4', 'sms')}
            statusBarBackground={themeMode === 'light' ? colors.shell : undefined}
        >
