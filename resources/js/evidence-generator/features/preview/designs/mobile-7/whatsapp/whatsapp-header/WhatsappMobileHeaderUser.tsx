...
import { Mobile7MoreVerticalIcon } from './Mobile7MoreVerticalIcon';
import type { WhatsappData, WhatsappMessageStatus as MsgStatus } from '../../../shared/whatsapp/whatsappTypes';
...
export function WhatsappMobileHeaderUser({
    ...
    const [showOnline] = useState(() => Math.random() < 0.5);
    ...
    return (
        <div className={['w-full border-b px-1.25 py-[11.5px]', isDark ? 'border-white/5 bg-[#0B1014]' : 'border-black/10 bg-white'].join(' ')}>
            <div className="flex items-center justify-between gap-2.5">
                <div className="flex min-w-0 flex-1 items-center gap-2.5">
                    <button
                        ...
                        title="Volver"
                    >
                        <ArrowLeft className="h-6.25 w-6.25" aria-hidden="true" strokeWidth={2.4} />
                    </button>
                    ...
                    <div className="min-w-0 flex-1 leading-tight">
                        <div
                            className={[
                                'truncate pb-[1.25px] text-[18.25px] leading-[20.25px] font-extralight tracking-tight',
                        ...
                        {showOnline && (
                            <div
                                className={['truncate text-[13.75px] font-light tracking-tight', isDark ? 'text-slate-400' : 'text-[#667781]'].join(' ')}
                                style={{
                ...
                <div className="flex shrink-0 items-center gap-[17.5px] text-[#54656f]">
                    ...
                    >
                        <svg viewBox="0 -4 22 22" height="30" width="26" fill="none">
                    ...
                    <span
                        ...
                        className={['h-[31.25px] w-[31.25px]', isDark ? 'text-slate-200' : 'text-black'].join(' ')}
                    >
                        <svg viewBox="0 -2 22 22" height="36" width="26" preserveAspectRatio="xMidYMid meet" fill="currentColor">
                            <title>ic-call</title>
                            <path
                    ...
                    <button
                        type="button"
                        className={[
                            'grid h-6.25 w-6.25 pr-1 pb-2 pt-1 mt-1 place-items-center rounded-full transition',
                            isDark ? 'text-slate-200 hover:bg-white/10 active:bg-white/15' : 'text-black hover:bg-black/5 active:bg-black/10',
                        ].join(' ')}
                        aria-label="Menu"
                        title="Menu"
                    >
                        <Mobile7MoreVerticalIcon className="h-[24px] w-[10px]" />
                    </button>
                </div>
            </div>
        </div>
