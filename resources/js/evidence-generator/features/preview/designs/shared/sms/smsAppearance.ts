    ...
    if (variant === 'mobile-1') {
        if (themeMode === 'dark') {
            return {
                ...
                sentText: '#FFFFFF',
                primaryText: '#E0E3E8',
                secondaryText: '#C2C7CD',
                headerIcon: '#C0C7CF',
                headerActionIcon: '#C0C7CF',
                composer: '#1C2023',
                tealPoint: '#70B9D1',
                link: '#C2C7CD',
                audioBackground: '#4C4161',
                audioIcon: '#EBDBFF',
                redPoint: '#E9A0A5',
                menuIndicator: '#E9A0A5',
                statusCheck: '#C2C7CD',
                readReceiptBackground: '#101817',
                readReceiptForeground: '#C2C7CD',
                metadataIcon: '#C2C7CD',
                avatarBackground: '#5CB973',
                avatarForeground: '#202125',
                systemNavigationForeground: '#C0C7CF',
                quickReplyBorder: '#42474D',
            };
        }
        return {
            shell: '#EAEDF2',
            ...
            systemNavigationForeground: '#42474D',
            quickReplyBorder: '#C0C7CD',
        };
    }
