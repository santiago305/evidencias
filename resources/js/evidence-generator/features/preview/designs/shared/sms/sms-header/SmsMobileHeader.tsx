...
export function SmsMobileHeader({
    ...
    const mobile6VideoActionWrapperClassName = 'relative -top-[3px] mr-[12px]';
    const mobile6MenuActionClassName = 'flex h-[42px] w-[35px] shrink-0 items-center justify-center';
        ...
        <header className="flex h-[72px] shrink-0 items-center px-3" style={{ backgroundColor: colors.header, color: colors.primaryText }}>
            ...
            <div
                ...
                style={{
                    ...
                    aspectRatio: '1 / 1',
                    borderRadius: '9999px',
                    backgroundColor: isMobile6
                        ? mobile6HeaderAvatarBackground
            ...
            >
                <svg
                    ...
                    fill={
                        isMobile6
                            ? mobile6HeaderAvatarForeground
                            : colors.avatarForeground
                    }
                    aria-hidden="true"
                >
            ...
            <HeaderIcon
                ...
                className={isMobile6 ? mobile6PhoneActionClassName : ''}
            >
            ...
            {showVideoCall ? (
                <button
                    ...
                    className={
                        variant === 'mobile-6'
                            ? `flex size-[42px] shrink-0 items-center justify-center ${mobile6VideoActionWrapperClassName}`
            ...
            <button type="button" className={mobile6MenuActionClassName} aria-label="Opciones">
