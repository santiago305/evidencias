...
export function buildContactIdentityDisplay(data: WhatsappData): ContactIdentityDisplay {
    ...
    if (!showPhoneInsteadOfName) {
        return { headerTitle: contactName, headerDisplaysPhone: false, profileTitle: contactName, profileSubtitle: phoneLabel, showAddContactAction: false };
    }
    ...
    return { headerTitle: phoneLabel, headerDisplaysPhone: true, profileTitle: phoneLabel, profileSubtitle, showAddContactAction: true };
}
