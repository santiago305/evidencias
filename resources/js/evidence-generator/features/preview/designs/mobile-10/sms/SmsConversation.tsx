...
import { Mobile10SmsSaveContactCard } from './Mobile10SmsSaveContactCard';
...
export function SmsConversation({
    ...
    const displayTelefono = formatMobile10SmsPhone(data.telefono);
    ...
    return (
        ...
        >
            <div className="flex-1 [scrollbar-width:none] overflow-y-auto px-2 pt-5 pb-[15px] [&::-webkit-scrollbar]:hidden">
                {conversationHeader.kind === 'sms' ? <Mobile10SmsSaveContactCard telefono={displayTelefono} themeMode={themeMode} /> : null}
                ...
                {conversationHeader.kind === 'rcs' ? (
                    <div className="mb-[22px] grid grid-cols-[48px_minmax(0,1fr)_18px] items-start px-[4px]" style={{ color: colors.secondaryText }}>
...
function formatMobile10SmsPhone(value: string): string {
