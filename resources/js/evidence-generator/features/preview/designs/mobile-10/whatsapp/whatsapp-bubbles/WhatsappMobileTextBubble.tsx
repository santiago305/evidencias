...
export function WhatsappMobileTextBubble({ side, firstInGroup, time, status, id, quote, themeMode = 'light', children }: WhatsappTextBubbleProps) {
    ...
    const metaText = colors ? '' : isDark ? 'text-[#878F92]' : '#0000000';
    ...
    return (
        <div id={id} className={`flex px-[15px] ${isOut ? 'justify-end' : 'justify-start'}`}>
            <div className="relative max-w-[90%] flex-none text-[12.75px] leading-[10.75px]">
                {firstInGroup && (
                    <BubbleTail
                ...
                <div className={bubbleClassName} style={bubbleStyle}>
                    <div className="box-border p-[5px] select-text">
                        ...
                        <div className="relative overflow-hidden ps-[3.75px] pe-[3.75px] break-words whitespace-pre-wrap">
                            <span
                                className="visible text-[14.6px] leading-[17px] font-normal !text-gray-600 tracking-tight"
                                    style={{
                                    minHeight: '0px',
                                }}
                            >
