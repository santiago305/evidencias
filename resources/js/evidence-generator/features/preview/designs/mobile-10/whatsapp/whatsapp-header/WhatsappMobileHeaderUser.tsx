...
import { Mobile10MoreVerticalIcon } from './Mobile10MoreVerticalIcon';
import type {
    WhatsappData,
            ...
            <div className="flex items-center justify-between gap-2.5">
                ...
                <div className="flex min-w-0 flex-1 items-center gap-2.5">
                    ...
                    <div className="min-w-0 flex-1 leading-tight !mt-2">
                        <div
                            className={[
                                'truncate pb-[1.25px] text-[18.25px] leading-[20.25px] font-normal !text-gray-600 tracking-tight',
                                isDark
                                    ? 'text-white'
                                    : 'text-[#111b21]',
                            ].join(' ')}
