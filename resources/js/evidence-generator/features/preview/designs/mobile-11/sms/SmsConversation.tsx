...
import { Mobile11SmsSaveContactCard } from './Mobile11SmsSaveContactCard';
    ...
    return (
        ...
        >
            <div className="flex-1 [scrollbar-width:none] overflow-y-auto px-2 pt-5 pb-[15px] [&::-webkit-scrollbar]:hidden">
                {conversationHeader.kind === 'sms' ? <Mobile11SmsSaveContactCard telefono={displayTelefono} themeMode={themeMode} /> : null}
