    ...
    return (
        <div className="shrink-0 px-2 pt-1.5 pb-2.5" style={{ backgroundColor: colors.conversation }}>
            <div className="flex items-end gap-[7px]">
                <div className="flex min-h-[54px] w-50 flex-1 items-center rounded-[29px] px-[11px]" style={{ backgroundColor: colors.composer }}>
                    <button
                        type="button"
                    ...
                    <button
                        type="button"
                        className="ml-4 flex size-9 shrink-0 items-center justify-center"
                        style={{ color: colors.headerIcon }}
                        aria-label="Galería"
                    >
