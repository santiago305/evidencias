...
export function WhatsappMobileInputBar({
    ...
    return (
        <div className="p-1.25 pb-[7.5px]">
            <div className="flex items-center gap-2">
                <div
                    className={[
                        'flex min-h-[50px] w-50 flex-1 items-center gap-2.5 rounded-full p-[7.5px]',
                ...
                >
                    ...
                    <div className="flex shrink-0 items-center gap-[14.5px]">
                ...
                <button
                    ...
                    className={[
                        'grid h-[50px] w-[50px] shrink-0 place-items-center rounded-full transition-colors mr-1',
                        isDark ? 'bg-[#F2F0F0] text-[#091219]' : 'bg-[#1DAB61] text-[#091219]',
                    ].join(' ')}
                >
