...
import { Mobile11MoreVerticalIcon } from './Mobile11MoreVerticalIcon';
...
export function WhatsappMobileHeaderUser({
    ...
    return (
        <div className={['w-full border-b px-1.25 py-[8.5px]', isDark ? 'border-white/5 bg-[#0B1014]' : 'border-black/10 bg-white'].join(' ')}>
            <div className="flex items-center justify-between gap-2.5">
                <div className="flex min-w-0 flex-1 items-center gap-2.5">
                    <button
                        ...
                        className={[
                            ...
                            isDark ? 'text-[#F2F0F0] active:bg-white/15' : 'text-black active:bg-black/10',
                        ].join(' ')}
                        aria-label="Volver"
                        title="Volver"
                    >
                    ...
                    <div className="relative h-[39px] w-[39px] shrink-0">
                        <div className="h-[39px] w-[39px] overflow-hidden rounded-full">
                ...
                <div className="flex shrink-0 items-center gap-[17.5px] text-[#54656f]">
                    <span
                        ...
                        className={['h-[31.25px] w-[31.25px]', isDark ? 'text-[#F2F0F0]' : 'text-black'].join(' ')}
                    >
                        <svg viewBox="0 0 22 22" height="24" width="24" fill="none">
                    ...
                    <span
                        ...
                        className={['h-[31.25px] w-[31.25px]', isDark ? 'text-[#F2F0F0]' : 'text-black'].join(' ')}
                    >
                        <svg viewBox="0 0 22 22" height="24" width="24" preserveAspectRatio="xMidYMid meet" fill="currentColor">
                            <title>ic-call</title>
                            <path
                    ...
                    <button
                        type="button"
                        className={[
                            'grid mb-1 h-6.25 w-6.25 pe-1.5 place-items-center rounded-full transition',
                            isDark ? 'text-[#F2F0F0] hover:bg-white/10 active:bg-white/15' : 'text-black hover:bg-black/5 active:bg-black/10',
                        ].join(' ')}
                        aria-label="Menu"
                        title="Menu"
                    >
                        <Mobile11MoreVerticalIcon width="4" height="24" />
                    </button>
                </div>
            </div>
        </div>
