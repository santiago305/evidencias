...
import { Mobile8MoreVerticalIcon } from './Mobile8MoreVerticalIcon';
            ...
            <div className="flex items-center justify-between gap-2.5">
                <div className="flex min-w-0 flex-1 items-center gap-2.5">
                    ...
                    <div className="min-w-0 flex-1 leading-tight">
                        <div
                            className={[
                                'truncate pb-[1.25px] text-[18.25px] leading-[20.25px] font-normal tracking-tight',
                        ...
                        {showOnline && (
                            <div
                                className={['truncate text-[12.75px] font-normal tracking-tight', isDark ? 'text-slate-400' : 'text-slate-600'].join(' ')}
                                style={{
                                    fontFamily: 'Roboto',
                                }}
                            >
                ...
                <div className="flex shrink-0 items-center gap-[17.5px] text-[#54656f]">
                    ...
                    <button
                        ...
                        title="Menu"
                    >
                        <Mobile8MoreVerticalIcon className="h-[24px] w-[10px]" />
                    </button>
                </div>
            </div>
        </div>
