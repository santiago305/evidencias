...
const MOBILE8_WHATSAPP_MICROPHONE_BACKGROUND = '#25D366';
const MOBILE8_WHATSAPP_MICROPHONE_ICON = '#FFFFFF';
    ...
    return (
        <div className="p-[5px] pb-[7.5px]">
            <div className="flex items-center gap-[5px]">
                <div
                    className={[
                        'flex min-h-[50px] w-[320px] items-center gap-2.5 rounded-full p-[7.5px]',
                ...
                >
                    <button type="button" aria-label="Emojis" className="grid h-[35px] w-[35px] shrink-0 place-items-center rounded-full">
                        <svg viewBox="0 0 24 24" height="26.5" width="26.5" preserveAspectRatio="xMidYMid meet" fill="none" aria-hidden="true">
                            <path
                    ...
                    <input
                        aria-label="Mensaje"
                        autoComplete="off"
                        className="min-w-0 flex-1 bg-transparent text-[18.25px] text-current outline-none placeholder:text-current/70"
                        placeholder="Mensaje"
                        spellCheck={false}
                    ...
                    <div className="flex shrink-0 items-center gap-[12.5px]">
                ...
                <button
                    ...
                    className={[
                        ...
                        colors ? '' : 'bg-[#161616] text-white',
                    ]
                        .filter(Boolean)
                        .join(' ')}
                    style={{ backgroundColor: MOBILE8_WHATSAPP_MICROPHONE_BACKGROUND, color: MOBILE8_WHATSAPP_MICROPHONE_ICON }}
                >
