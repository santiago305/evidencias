...
export function Mobile8EncryptedMessage({ themeMode = 'light' }: { themeMode?: PreviewThemeMode }) {
                                    ...
                                    <div className="relative z-10 rounded-[9.1875px]">
                                        <div className="cursorpointer">
                                            <span>
                                                ...
                                                <span className={`visible min-h-0 text-black ${encryptedTextSize}`}
                                                style={{ fontFamily: 'Roboto', fontWeight: 400, color: isDark ? '#EECC84' : 'rgba(0, 0, 0, 0.6)' }}>
                                                    ...
                                                    <strong style={{fontWeight:600}}>Más información.</strong>
                                                </span>
                                            </span>
                                        </div>
