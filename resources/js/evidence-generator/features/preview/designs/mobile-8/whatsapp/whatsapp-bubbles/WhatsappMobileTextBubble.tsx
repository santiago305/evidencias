...
export function WhatsappMobileTextBubble({ side, firstInGroup, time, status, id, quote, themeMode = 'light', children }: WhatsappTextBubbleProps) {
    ...
    return (
        <div id={id} className={`flex px-[15px] ${isOut ? 'justify-end' : 'justify-start'}`}>
            <div className="relative max-w-[87%] flex-none text-[11px] leading-[12.75px]">
                {firstInGroup && (
                    <BubbleTail
                ...
                <div className={bubbleClassName} style={bubbleStyle}>
                    <div className="box-border p-[5px] select-text">
                        ...
                        <div className="relative overflow-hidden ps-[3.75px] pe-[3.75px]  whitespace-pre-wrap">
                            <span
                                className="visible text-[13.9px]"
                                style={{ minHeight: '0px', fontFamily: 'Roboto', fontWeight: 400, color: colors ? (isOut ? colors.outgoingText : colors.incomingText) : undefined }}
                            >
                                {content}
                            </span>
                            <span>
