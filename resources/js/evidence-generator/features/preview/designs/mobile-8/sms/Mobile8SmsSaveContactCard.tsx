...
import { Mobile8SmsSaveContactIcon } from './Mobile8SmsSaveContactIcon';
import { getSmsColors } from './smsAppearance';

type Mobile8SmsSaveContactCardProps = {
    telefono: string;
    themeMode: PreviewThemeMode;
};

export function Mobile8SmsSaveContactCard({ telefono, themeMode }: Mobile8SmsSaveContactCardProps) {
    ...
    return (
        <div className="mx-[3px] pb-[20px]" data-mobile8-sms-save-contact-card="true">
            <section
