...
import { Mobile8SmsSaveContactCard } from './Mobile8SmsSaveContactCard';
    ...
    return (
        ...
        >
            <div className="flex-1 [scrollbar-width:none] overflow-y-auto px-2 pt-5 pb-[15px] [&::-webkit-scrollbar]:hidden">
                {conversationHeader.kind === 'sms' ? <Mobile8SmsSaveContactCard telefono={displayTelefono} themeMode={themeMode} /> : null}
                ...
                <div
                    className={`text-center text-[11px] leading-4 ${conversationHeader.kind === 'sms' ? 'mb-[13px]' : 'mb-[0px]'}`}
                ...
                {conversationHeader.kind === 'rcs' ? (
                    <div className="mb-[21px] grid grid-cols-[48px_minmax(0,1fr)_18px] items-start px-[4px]" style={{ color: colors.secondaryText }}>
                        ...
                        <div className="min-w-0 text-center text-[11px] leading-[15px]">
