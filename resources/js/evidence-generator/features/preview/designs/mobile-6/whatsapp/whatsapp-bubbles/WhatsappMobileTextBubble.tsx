            ...
            <div className="relative max-w-[90%] flex-none text-[17.75px] leading-[23.75px]">
                ...
                <div className={bubbleClassName} style={bubbleStyle}>
                    <div className="box-border p-[5px] select-text">
                        ...
                        <div className="relative overflow-hidden ps-[3.75px] pe-[3.75px] leading-[17.5px] break-words whitespace-pre-wrap">
                            <span
                                data-testid="selectable-text"
                                dir="ltr"
                                className="visible text-[13.12px] text-black/80 leading-[15.5px] font-normal tracking-[0.00625rem] select-text [&_strong]:text-[14px] [&_strong]:leading-[17.5px] [&_strong]:font-[550] "
                                style={{ minHeight: '0px' }}
                            >
                                {content}
                            </span>
