...
import { Mobile6MoreVerticalIcon } from './Mobile6MoreVerticalIcon';
...
export function WhatsappMobileHeaderUser({
    ...
    return (
        <div
            className={[
                'w-full border-b px-[5px] py-[7.5px]',
                colors
                    ? isDark
                        ? 'border-white/5'
                        : 'border-black/10'
            ...
            <div className="flex items-center justify-between gap-2.5">
                ...
                <div className="flex min-w-0 flex-1 items-center gap-2.5">
                    ...
                    <div className="min-w-0 flex-1 leading-tight">
                        <div
                            className={[
                                'truncate pb-[1.25px] text-[17.25px] leading-[21.25px] tracking-wide',
                                colors
                                    ? ''
                                    : isDark
                                      ? 'text-white'
                        ...
                        {headerStatus.type !== 'hidden' && (
                            <div
                                className={[
                                    'truncate text-[10.75px] font-normal',
                                    isDark
                                        ? 'text-slate-400'
                                        : 'text-[#667781]',
                                ].join(' ')}
                ...
                <div className="flex shrink-0 items-center gap-[17.5px] text-[#54656f]">
                    ...
                    <span
                        ...
                        className={[
                            'grid h-[31.25px] w-[31.25px] shrink-0 place-items-center',
                            colors
                                ? ''
                                : isDark
                                  ? 'text-slate-200'
                    ...
                    <button
                        type="button"
                        className={[
                            'grid h-[31.25px] w-[31.25px] shrink-0 place-items-center rounded-full transition',
                            colors
                                ? isDark
                        ...
                        title="Menu"
                    >
                        <Mobile6MoreVerticalIcon className="h-[24px] w-[10px]" />
                    </button>
                </div>
            </div>
        </div>
