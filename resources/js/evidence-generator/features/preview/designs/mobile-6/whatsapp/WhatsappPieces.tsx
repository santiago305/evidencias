...
export function EncryptedMessage({ themeMode = 'light' }: { themeMode?: PreviewThemeMode }) {
    const isDark = themeMode === 'dark';
    const encryptedTextSize = 'text-[10.2px] leading-[9px]';
                    ...
                    <div className="flex justify-center">
                        <div>
                            <div className={`mx-auto flex ${maxWidth} flex-col justify-center ${horizontalPadding}`}>
                                ...
                                <div
                                    className={[
                                        'relative mb-0 box-border inline-block max-w-full flex-none rounded-[9.1875px] px-[15px] pt-[5px] pb-[6.25px] text-center text-[12.5px] leading-[12px] shadow-[0_1px_0.5px_rgba(11,20,26,0.13)]',
                                        isDark ? 'bg-[#12181C] text-[#EECC84]' : 'bg-[#FFF0D4] text-[#667781]',
                                    ].join(' ')}
                                >
