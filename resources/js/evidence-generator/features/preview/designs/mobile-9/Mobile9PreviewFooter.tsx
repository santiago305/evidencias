...
import { Mobile9BackIcon } from './components/navigation/Mobile9BackIcon';
import { Mobile9HomeIcon } from './components/navigation/Mobile9HomeIcon';
import { Mobile9RecentsIcon } from './components/navigation/Mobile9RecentsIcon';

const MOBILE9_FOOTER_LIGHT_BACKGROUND = '#F9F9FB';
const MOBILE9_FOOTER_LIGHT_FOREGROUND = '#787878';

export function Mobile9PreviewFooter({
    themeMode,
    variant = 'default',
    ...
    return (
      <div
        ...
        data-mobile9-system-navigation="three-button"
    >
