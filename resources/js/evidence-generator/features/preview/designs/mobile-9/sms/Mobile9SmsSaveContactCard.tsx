...
import { Mobile9SmsSaveContactIcon } from './Mobile9SmsSaveContactIcon';
import { getSmsColors } from './smsAppearance';

type Mobile9SmsSaveContactCardProps = {
    telefono: string;
    themeMode: PreviewThemeMode;
};

export function Mobile9SmsSaveContactCard({ telefono, themeMode }: Mobile9SmsSaveContactCardProps) {
    ...
    return (
        <div className="mx-[3px] pb-[20px]" data-mobile9-sms-save-contact-card="true">
            <section
