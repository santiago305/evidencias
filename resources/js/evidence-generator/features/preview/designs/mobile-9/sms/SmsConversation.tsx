...
import { Mobile9SmsSaveContactCard } from './Mobile9SmsSaveContactCard';
...
export function SmsConversation({
    ...
    const displayTelefono = formatMobile9SmsPhone(data.telefono);
    ...
    return (
        ...
        >
            <div className="flex-1 [scrollbar-width:none] overflow-y-auto px-2 pt-5 pb-[15px] [&::-webkit-scrollbar]:hidden">
                {conversationHeader.kind === 'sms' ? <Mobile9SmsSaveContactCard telefono={displayTelefono} themeMode={themeMode} /> : null}
...
function formatMobile9SmsPhone(value: string): string {
