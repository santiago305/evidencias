...
import { Mobile9MoreVerticalIcon } from './Mobile9MoreVerticalIcon';
import type {
    WhatsappData,
    WhatsappMessageStatus as MsgStatus,
...
export function WhatsappMobileHeaderUser({
    ...
    return (
        <div
            className={[
                'w-full border-b px-1.25 py-[11.5px]',
                isDark
            ...
            <div className="flex items-center justify-between gap-2.5">
                ...
                <div className="flex min-w-0 flex-1 items-center gap-2.5">
                    ...
                    <div className="relative h-[45px] w-[45px] shrink-0">
                        ...
                        {/* INDICADOR DE MENSAJES TEMPORALES */}
                    ...
                    {/* =====================================
                        NOMBRE
                        ===================================== */}
                    <div className="min-w-0 flex-1 leading-tight !mt-2">
                        <div
                            className={[
                        ...
                        {/* {showOnline && (
                            <div
                                className={[
                                    'truncate text-[13.75px] font-light tracking-tight',
                                    isDark
                                        ? 'text-slate-400'
                                        : 'text-[#667781]',
                                ].join(' ')}
                ...
                {/* =========================================
                    ACCIONES DERECHA
                    ========================================= */}
                <div className="flex shrink-0 items-center gap-[22.5px] text-[#54656f]">
                    ...
                    <button
                        ...
                        title="Menu"
                    >
                        <Mobile9MoreVerticalIcon
                            className="h-[21px] w-[7px]"
                        />
                    </button>
                </div>
            </div>
