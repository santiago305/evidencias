...
export function WhatsappMobileTextBubble({ side, firstInGroup, time, status, id, quote, children }: WhatsappTextBubbleProps) {
    ...
    return (
        <div id={id} className={`flex px-3 ${isOut ? 'justify-end' : 'justify-start'}`}>
            <div className="relative max-w-[90%] flex-none text-[14.2px] leading-4.75">
